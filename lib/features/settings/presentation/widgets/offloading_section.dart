        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text('Processing Mode', style: AppTypography.bodyLarge.copyWith(fontWeight: FontWeight.w600)),
            ],
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Your stress level is calculated using HRV analysis. Choose WHERE processing runs:',
                  style: AppTypography.bodySmall.copyWith(color: AppColors.textSecondary),
                ),
                const SizedBox(height: 8),
                _buildMiniExplain(Icons.phone_android, AppColors.edgeMode, 'EDGE', 'On your phone (fast, works offline)'),
                const SizedBox(height: 4),
                _buildMiniExplain(Icons.cloud, AppColors.cloudMode, 'CLOUD', 'On server (when WiFi available)'),
              ],
            ),
          ),
